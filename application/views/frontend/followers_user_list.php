<div class="col-sm-9 col-md-10 affix-content home-product-wrap ">
						...
						<div class="ro-w">
						<?php foreach($this->followers_list as $user_list){  
							
							$this->load->model('home_model');
							$user_detail = $this->home_model->get_user_details($user_list['following_user_id']);
									...
									<div class="ro-w">
										<div class="caption-follwer">
											...
											<?php } else { ?>
												...
												<span class="follow-rate"><?php echo $user['followed_count'] ?></span>  Followers
